...
private let kActionViewHeight: CGFloat = 100    //container view height
...
class TSMessageActionFloatView: UIView {
    ...
    fileprivate func initContent() {
        ...
        let actionImages = [
            UIImage(from: .fontAwesome, code: "rsssquare", textColor: .white, backgroundColor: .clear, size: CGSize(width: 20, height: 20)),
            UIImage(from: .fontAwesome, code: "flickr", textColor: .white, backgroundColor: .clear, size: CGSize(width: 20, height: 20))
        ]
